...
<h5>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silakan transfer  di rekening <strong>Bank BRI Nomer Rekening : 32113-821312-134</strong>dengan nominal : <strong>Rp. {{ number_format($pesanan->Kode+$pesanan->jumlah_harga) }}</strong></h5>
</div>
    </div>
<div class="card mt-2">
<div class="card-body">
